...
export async function inspect (page: Page, model: string, userInput: string, action: string, matchTextOnly: boolean, settings: BrowserSettings, keywords?: string[]): Promise<string[]> {
  if (userInput === '') {
...
export async function inspectForSelect (page: Page, model: string, userInput: string, userSelection: string, settings: BrowserSettings, keywords?: string[]): Promise<{ selector: string, option: string }> {
  let elementData = ''
