...
export async function click (page: Page, model: string, userInput: string, keywords: string[], allElements: boolean, matchTextOnly: boolean, settings: BrowserSettings): Promise<void> {
  const locators = await inspect(page, model, userInput, 'click', matchTextOnly, settings, keywords)
